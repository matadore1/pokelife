...
* Dodanie różnych kolorów przycisków do szybkiego rozkładania przedmiotów, w zależności od poziomu przedmiotu. Niebieskie dla poziomu I, żółte dla poziomu II oraz czerwone dla poziomu III.
